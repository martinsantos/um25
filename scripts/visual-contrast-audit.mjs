...
const routes = [
  ...
  { path: '/en/services', label: 'en services default', canonical: 'https://www.ultimamilla.com.ar/en/services', requiresFirstViewportCta: true },
  { path: '/en/about', label: 'en about default', canonical: 'https://www.ultimamilla.com.ar/en/about', requiresFirstViewportCta: true },
  { path: '/en/contacto', label: 'en contacto default', canonical: 'https://www.ultimamilla.com.ar/en/contacto', requiresFirstViewportCta: true },
  { path: '/geo', label: 'geo index default', canonical: 'https://www.ultimamilla.com.ar/geo' },
  { path: '/servicios-it-empresas-mendoza', label: 'geo mendoza default', canonical: 'https://www.ultimamilla.com.ar/servicios-it-empresas-mendoza', requiresFirstViewportCta: true },
  { path: '/servicios-it-empresas-mendoza?skin=white', label: 'geo mendoza', canonical: 'https://www.ultimamilla.com.ar/servicios-it-empresas-mendoza', requiresFirstViewportCta: true },
  { path: '/servicios-it-empresas-argentina', label: 'geo argentina default', canonical: 'https://www.ultimamilla.com.ar/servicios-it-empresas-argentina', requiresFirstViewportCta: true },
  { path: '/servicios-it-empresas-argentina?skin=white', label: 'geo argentina', canonical: 'https://www.ultimamilla.com.ar/servicios-it-empresas-argentina', requiresFirstViewportCta: true },
  { path: '/presupuesto-servicios-it-empresas', label: 'geo presupuesto default', canonical: 'https://www.ultimamilla.com.ar/presupuesto-servicios-it-empresas', requiresFirstViewportCta: true },
