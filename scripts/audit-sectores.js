/**
 * Script para auditar sectores en Directus
 * Analiza todos los valores de Area en antecedentes y sugiere nuevos sectores
 *
 * Uso: node scripts/audit-sectores.js
 */
...
/**
 * Audita los sectores en Directus
 */
async function auditSectores() {
  console.log('🔍 Auditando sectores en Directus Antecedentes...\n');

  try {
    // Crear cliente Directus
    const client = createDirectus('http://localhost:8055').with(rest());

    // Obtener todos los antecedentes con campo Area
