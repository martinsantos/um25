...
echo "============================================="
execute_ssh "curl -s -I https://www.ultimamilla.com.ar | head -1" "Página principal"
execute_ssh "curl -s -I https://www.ultimamilla.com.ar/servicios | head -1" "Página de servicios"
execute_ssh "curl -s -I https://www.ultimamilla.com.ar/antecedentes | head -1" "Página de antecedentes"
...
echo "• Frontend público: https://www.ultimamilla.com.ar"
