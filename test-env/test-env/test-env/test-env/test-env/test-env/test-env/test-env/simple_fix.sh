...
# Este script implementa una solución simple para el problema de autenticación

echo "Actualizando el archivo .env en el servidor..."
...
echo "Actualizando el archivo .env.js en el directorio dist..."
