...
# Crear un nuevo archivo docker-compose.server.yml con límites de tamaño de archivo actualizados
...
echo "Configuración de Directus actualizada y contenedores reiniciados"
