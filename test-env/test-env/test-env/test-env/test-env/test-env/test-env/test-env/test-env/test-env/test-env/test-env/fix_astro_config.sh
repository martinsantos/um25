...
# Crear un archivo .env con la configuración correcta
...
DIRECTUS_STATIC_TOKEN=eqGR2YD4QrMIsftG6V2FR5MuNu0Ope6-
...
echo "Configuración de Astro actualizada y contenedores reiniciados"
