...
function formatRealOnlyResults(antecedentes: CliAntecedente[], servicios: CliServicio[]): FormattedResult[] {
...
async function queryDirectusRealOnly(searchQuery: string): Promise<FormattedResult[]> {
    try {
        ...
        return formatRealOnlyResults(antecedentes, servicios);
        ...
        return formatRealOnlyResults(fallback.antecedentes, fallback.servicios);
    }
}
