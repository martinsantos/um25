  ...
  switch (resource) {
    ...
    case 'authority':
      return {
        ...
        trustSignals: ['Trayectoria pública', 'Casos técnicos', 'Cobertura regional', 'Servicios conectados', 'Contacto institucional'],
    ...
    case 'blog-index':
      return {
        ...
        blog: {
          ...
          recommendedTopics: ['continuidad operativa', 'seguridad electrónica', 'soporte IT', 'software operativo', 'infraestructura trazable'],
        },
      };
