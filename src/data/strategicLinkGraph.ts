...
export const geoDiscoveryStrategicGroups: StrategicLinkGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/geo/brand-facts.json',
        label: 'brand-facts.json',
        summary: 'Datos oficiales de identidad, cobertura, contacto y politica de citas.',
        eyebrow: 'JSON',
        kind: 'geoResource',
      },
      {
        href: '/geo/services.json',
        label: 'services.json',
        summary: 'Catalogo de servicios con canonicals estables y categorias tecnicas.',
        eyebrow: 'JSON',
        kind: 'geoResource',
      },
    ],
