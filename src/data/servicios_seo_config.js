 ...
 * Basada en PROPUESTA_SEO_MEJORAS.md
...
export const serviciosSEO = {
  7: {
    ...
    title: 'Infraestructura de Redes Mendoza | Cableado, Fibra Óptica, Radioenlaces | ULTIMA MILLA',
  ...
  8: {
    ...
    title: 'Desarrollo de Software a Medida Mendoza | Web, Mobile, ERP | ULTIMA MILLA',
  ...
  3: {
    ...
    title: 'Seguridad Informática y Ciberseguridad Mendoza | CCTV, Control Acceso | ULTIMA MILLA',
  ...
  10: {
    ...
    title: 'Soporte Técnico 24/7 Mendoza | Mesa de Ayuda, Mantenimiento IT | ULTIMA MILLA',
  ...
  11: {
    ...
    title: 'Cloud Computing y Migración a la Nube Mendoza | AWS Azure GCP | ULTIMA MILLA',
  ...
  12: {
    // CONSULTORÍA IT
    slug: 'consultoria-it',
    title: 'Consultoría IT y Transformación Digital Mendoza | Arquitectura, Auditoría | ULTIMA MILLA',
