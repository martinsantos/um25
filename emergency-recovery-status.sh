...
echo "✅ http://ultimamilla.com.ar/ = HTTP 200 OK"
echo "✅ DNS ultimamilla.com.ar = 23.105.176.45"
echo "❌ https://ultimamilla.com.ar/ = Puerto 443 cerrado"
echo "❌ www.ultimamilla.com.ar = NXDOMAIN"
echo ""

echo -e "${RED}❌ DESPUÉS DE CONFIGURACIONES:${NC}"
echo "❌ http://ultimamilla.com.ar/ = DNS no resuelve"
echo "❌ DNS ultimamilla.com.ar = 0 ANSWER records"
echo "❌ https://ultimamilla.com.ar/ = DNS no resuelve"
echo "❌ www.ultimamilla.com.ar = NXDOMAIN"
...
echo ""
echo "1. DNS Query ultimamilla.com.ar:"
dig ultimamilla.com.ar @8.8.8.8 | grep -E "(ANSWER|AUTHORITY)" -A 2
...
echo "   - Ve a: DNS → Manage DNS → ultimamilla.com.ar"
echo "   - RESTAURAR registro A: ultimamilla.com.ar → $SERVER_IP"
echo "   - Ve a: Websites → List Websites → ultimamilla.com.ar"
...
echo "   Dominio: ultimamilla.com.ar"
echo "   IP: $SERVER_IP"
...
echo "nslookup ultimamilla.com.ar"
echo "dig ultimamilla.com.ar @8.8.8.8"
echo ""
...
echo "✅ DNS ultimamilla.com.ar → $SERVER_IP"
echo "✅ http://ultimamilla.com.ar/ → HTTP 200"
