...
# Configuración
MODEL = "mistral"  # Cambiado de llama3 a mistral
OLLAMA_URL = "http://localhost:11434/api/generate"
INPUT_FILE = "antecedentes_enriquecidos_v5.json"
OUTPUT_FILE = "antecedentes_mistrall_v2.json"
...
# Prompts optimizados para enriquecimiento con formato Mistral
PROMPT_TITULO_SEO = """<s>[INST]
...
PROMPT_DESCRIPCION_UNIFICADA = """<s>[INST]
...
PROMPT_NORMALIZACION_CLIENTE = """<s>[INST]
...
class AntecedenteProcessor:
        ...
        try:
            payload = {
                ...
                "options": {
                    ...
                    "num_ctx": 4096,
                    # Parámetros adicionales para Mistral
                    "top_p": 0.9,
                    "top_k": 40
                }
            }
    ...
    def limpiar_texto(self, texto: str) -> str:
        """Limpieza exhaustiva de texto (adaptada para formato Mistral)"""
