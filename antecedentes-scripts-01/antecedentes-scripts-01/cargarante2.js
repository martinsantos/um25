...
const IMAGE_MAPPING_FILE = './datos_imagenes_para_directus_20250413_112129.json'; // JSON que mapea títulos a imágenes
const IMAGE_BASE_FOLDER = './imagenes-realistas-v2'; // Carpeta donde están las imágenes .png/.jpg etc.
...
const PROVIDED_TOKEN = "bqvkfpf7Zl2-oZsCCtSdE8hRTms6YqD_"; // Puede estar vacío para forzar login
