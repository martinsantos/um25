...
describe('seoUrl helpers', () => {
  test('normalizes canonicals to the www production domain', () => {
    expect(stripWww('https://www.ultimamilla.com.ar/servicios')).toBe('https://www.ultimamilla.com.ar/servicios');
    expect(canonicalUrl('/servicios/')).toBe('https://www.ultimamilla.com.ar/servicios');
    expect(canonicalUrl('https://www.ultimamilla.com.ar/blog/nota/')).toBe('https://www.ultimamilla.com.ar/blog/nota');
