...
curl -s -o /dev/null -w "%{http_code}" "https://umbot.com.ar/servicios/2/redes-de-datos" || echo "ERROR en prueba externa"
...
echo ""
echo "Próximos pasos:"
echo "1. Verificar https://umbot.com.ar/servicios/2/redes-de-datos"
